...
import { cssVarsPlugin, preset, themeColors } from './config/tailwindFormat.js';
import { rgbChannels } from './config/transform.js';
import { esModuleFormat } from './config/esModuleFormat.js';
...
StyleDictionary.registerFormat({
  name: 'esModule/nested',
  format: esModuleFormat,
});
